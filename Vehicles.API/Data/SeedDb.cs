...
namespace Vehicles.API.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1010", "Kevin", "Torres", "kevin@yopmail.com", "311 322 4620", "Calle Luna Calle Sol", UserType.Admin);
        ...
        private async Task CheckBrandsAsync()
        {
            if (!_context.Brands.Any())
            {
                ...
                _context.Brands.Add(new Brand { Description = "WolksVagen" });
                ...
                _context.Brands.Add(new Brand { Description = "Lamborghini" });
