...
namespace Vehicles.API.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public UsersController(DataContext context, IUserHelper userHelper,
            ICombosHelper combosHelper, IConverterHelper converterHelper, IBlobHelper blobHelper, IMailHelper mailHelper)
        {
            _context = context;
        ...
        public IActionResult Create()
        {
            ...
            {
                DocumentTypes = _combosHelper.GetCombosDocumentsTypes()
            };
        ...
        public async Task<IActionResult> Create(UserViewModel model)
        {
            ...
            model.DocumentTypes = _combosHelper.GetCombosDocumentsTypes();
            return View(model);
        }
        ...
        public async Task<IActionResult> AddVehicle(VehicleViewModel vehicleViewModel)
        {
            ...
            {
                imageId = await _blobHelper.UploadBlobAsync(vehicleViewModel.ImageFile, "vehicle");
            }
        ...
        public async Task<IActionResult> DeleteImageVehicle(int? id)
        {
            ...
            VehiclePhoto vehiclePhoto = await _context.VehiclePhtos
                .Include(x => x.Vehicle)
                .FirstOrDefaultAsync(x => x.Id == id);
            ...
            _context.VehiclePhtos.Remove(vehiclePhoto);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> AddVehicleImage(VehiclePhotoViewModel model)
        {
            if (ModelState.IsValid)
            {
                Guid imageId = await _blobHelper.UploadBlobAsync(model.ImageFile, "vehicle");
                Vehicle vehicle = await _context.Vehicle
                    .Include(x => x.VehiclePhotos)
