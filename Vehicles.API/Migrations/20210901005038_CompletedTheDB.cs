...
{
    public partial class CompletedTheDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehiclePhtos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VehiclePhtos_Vehicle_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicle",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehiclePhtos_VehicleId",
                table: "VehiclePhtos",
                column: "VehicleId");
        }
